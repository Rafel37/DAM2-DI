...
public class Main extends JFrame{
    ...
    // AQUI PONER EL TIPO DE VENTANA QUE HEMOS ELEGIDO
    /*
    ...
    private void instancias() {
        ...
        // buton = new Jbutton ("texto del boton")
    }

    private void innitGUI() {

        // COLOCACION DE LOS ELEMENTOS EN LA VENTANA
        /*
    ...
    // PARA LOS LISTENERS Y FUNCIONALIDADES DE CADA ELEMENTO
