...
import zmorralla.textpademo.ActionPerformer;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        javax.swing.SwingUtilities.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new Main().jFrame.setVisible(true);    //hace visible la GUI creada por la clase Main
            }
        });
    }
    ...
    public Main() {
        ...
        eventHandler = new Main.EventHandler();                 //construye una instancia de EventHandler
        actionPerformer = new ActionPerformer(Main.this);    //construye una instancia de ActionPerformer
    ...
    private void buildToolBar() {
        ...
        buttonCut.setIcon(new ImageIcon(getClass().getResource("../res/cut.png")));
        buttonCut.setActionCommand("cmd_cut");

        JButton buttonCopy = new JButton();
        buttonCopy.setToolTipText("Copiar");
        buttonCopy.setIcon(new ImageIcon(getClass().getResource("../res/copy.png")));
        buttonCopy.setActionCommand("cmd_copy");

        JButton buttonPaste = new JButton();
        buttonPaste.setToolTipText("Pegar");
        buttonPaste.setIcon(new ImageIcon(getClass().getResource("../res/paste.png")));
     ...
     */
    Main.EventHandler getEventHandler() {
        return eventHandler;
    }
