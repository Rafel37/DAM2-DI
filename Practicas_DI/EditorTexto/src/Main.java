...
public class Main extends JFrame implements ActionListener, ChangeListener {
    ...
    JLabel typeLabel;
    DefaultComboBoxModel modeloFuente;
    JComboBox type;
    ...
    private void instancias() {
        ...
        type = new JComboBox();
        modeloFuente = new DefaultComboBoxModel();
    }
    ...
    public void cambioFuente(){
        String[] tipoFuente = GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames();
        for (String letra : tipoFuente){
            modeloFuente.addElement(letra);
        }
    }
    ...
    public void stateChanged(ChangeEvent changeEvent) {
        //TAMAÑO LETRA
        Font font = new Font(modeloNumero.getValue().toString(), Font.PLAIN, Integer.valueOf(size.getValue().toString()));
